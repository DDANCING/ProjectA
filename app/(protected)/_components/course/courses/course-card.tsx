...
export const CourseCard = ({
  ...
  return ( 
    ...
    <Card className="group shadow-none border hover:shadow-[0_0_2px_#fff,inset_0_0_2px_#fff,0_0_5px_#7C3AED,0_0_15px_#7C3AED,0_0_30px_#7C3AED] transition overflow-hidden border-foreground p-3 h-[30vh] flex flex-col">
